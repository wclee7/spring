...
/**
 * 2014-12-08
 * Hoon-Ki Kim. rymf0802@tlab.co.kr
 */
...
//                popUp.error('서버 요청 중 오류');
//            }
//
//            else if (status >= 500 && status < 600) {
//                popUp.error('서버 작업 중 오류');
//            }
            if (callback) {
                callback();
            }
...
/**
 * 페이지 내 모든 FORM 들을 AJAX 대응되도록 수정
 * @returns {undefined}
 */
////function ajaxSubmitSetting(formId) {
//function ajaxSubmitSetting(targetUrl, customOption) {
//  logger.debug('페이지 내 모든 form ajax 대응 작업');
//
//  var defaultOption = {
//    beforeSubmit: function (formData, jqForm, options) {
...
//
//    if (divWidth > image.width) {
//        console.log('case 3');
//        
//        var gap = divWidth - image.width;
//        console.log(gap);
//        image.style.marginLeft = (gap / 2) + 'px';
//        changeBackground(ctn);
//    }

// 상하 여백 맞추기 위한 margin 조건.. 
//    if (divHeight > image.height) {
//        console.log('case 4');
//        logger.debug('margin top ');
//        var gap = divHeight - image.height;
//        image.style.marginTop = (gap / 2) + 'px';
//        logger.debug(image.style.marginTop);
//        changeBackground(ctn);
//    }
