...
public class HibernateConfig {
    ...
    // hibernate 연동, FactoryBean 상속, 빈선언 시 getObject() 호출되어 객체 반환
    @Bean
    ...
    public DataSource dataSource() {
        ...
        logger.info("### jdbcMaxIdle : " + jdbcMaxIdle); // 최대로 유지 될 수 있는 커넥션 개수
       ...
       DataSource dataSource = new DataSource();
        ...
        //dataSource.setPassword(jdbcPwd);  // >> 패스워드 방식으로 변경 
